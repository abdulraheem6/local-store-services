          ...
          <div className="filter-group">
            ...
            <div className="select-wrapper">
              ...
              >
                ...
                {locations.cities && filters.state && locations.cities[filters.state] ? (
                  locations.cities[filters.state].map(city => (
          ...
          <div className="filter-group">
            ...
            <div className="select-wrapper">
              ...
              >
                ...
                {locations.mandals && filters.city && locations.mandals[filters.city] ? (
                  locations.mandals[filters.city].map(mandal => (
...
//   isSearchEnabled
// }) => {
//   // Extract arrays for rendering
//   const states = Array.isArray(locations.states) ? locations.states : [];
//   const cities = Array.isArray(locations.currentCities) ? locations.currentCities : [];
//   const mandals = Array.isArray(locations.currentMandals) ? locations.currentMandals : [];
//   const categoryOptions = Object.keys(categories || {});
